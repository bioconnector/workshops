...
output: 
  slidy_presentation:
    footer: "bioconnector.org | Essential Statistics with R"
---
...
- This is _not_ an introductory R class. Pre-requisites: 
    ...
    - Familiarity with dplyr `%>%` and ggplot2 recommended
...
- Data
- Setup instructions
- Lessons dropdown: _check back immediately after course_
...
# Make it a tbl for better printing
library(dplyr)
nh <- tbl_df(nh)
```
