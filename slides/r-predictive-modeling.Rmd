...
<small><small><small>Ask for help if any of these fail with an error. Setup instructions at **bioconnector.org** under the _Setup_ -- _Predictive modeling_ heading.</small></small>  
<small><small><small>Use **`install.packages("theMissingPackage")`** as needed.</small></small></small>
