...
> **Extra credit assignment**: Take a look at the [advanced data manipulation](r-dplyr-yeast.html) and [tidy data](r-tidy.html) workshops, and see if you can figure out how to join the gene expression data to the clinical data for any particular cancer type.
